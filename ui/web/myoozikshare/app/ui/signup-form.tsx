          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <AtSymbolIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 dark:text-gray-200 peer-focus:text-gray-900 dark:peer-focus:text-gray-50" />
            </div>
          </div>
          <div className="mt-4">
            <label
